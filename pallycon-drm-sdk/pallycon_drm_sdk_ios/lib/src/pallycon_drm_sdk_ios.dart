...
/// An implementation of [PallyconDrmSdkIosPlatform] that uses method channels.
class PallyConDrmSdkIos extends PallyConDrmSdkPlatform {
  /// The method channel used to interact with the native platform.
  static const _methodChannel =
  MethodChannel('com.pallycon.drmsdk/ios');
  ...
  static void registerWith() {
    PallyConDrmSdkPlatform.instance = PallyConDrmSdkIos._privateConstructor();
  }

  PallyConDrmSdkIos._privateConstructor();

  static final PallyConDrmSdkIos shared = PallyConDrmSdkIos._privateConstructor();
